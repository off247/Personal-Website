export const visualStorytelling = [
  {
    ...
    client: 'Web-based presentation decks built for client use',
    tags: ['UX', 'UI', 'Web'],
    thumb: '/assets/redwings_250909.png',
    cover: '/assets/redwings_250909.png',
    alt: 'Detroit Red Wings hero',
    summary: 'During my time at Sportsdigita, I designed and built interactive presentation decks in the Digideck platform for major sports and corporate clients. I collaborated closely with sales teams and brand stakeholders, creating mockups in Illustrator and Adobe XD before building final decks in Digideck. Despite the platform\'s limitations, I developed creative workarounds with custom Illustrator elements to achieve polished, on-brand designs. By leveraging lindear storytelling and sequential animations, I made complex content easier for audiences to follow and more engaging to experience.',
    stats: [
    { label: 'Role', value: 'Presentation Design Specialist' },
    { label: 'Scope', value: '20 interactive slides with on-enter motion; title/nav + interior templates' },
    { label: 'Toolkit', value: 'Digideck, Illustrator' }
    ],
    links: [
    ...
    { title: 'SMUMN Video?', tags: ['photo', 'color grading'], thumb: '/assets/capabilities/visual_storytelling_thumb250909.png' },  
    { title: 'Veritas?', tags: ['photo', 'color grading'], thumb: '/assets/capabilities/visual_storytelling_thumb250909.png' },  
    { title: 'Wedding?', tags: ['photo', 'color grading'], thumb: '/assets/capabilities/visual_storytelling_thumb250909.png' },  
  ]
  
  export const socialMedia = [
    { title: 'Timberwolves Playoff Szn', tags: ['campaign', 'motion'], thumb: '/assets/capabilities/social_media_250909.png' },
    { title: 'UGC: Product How-To', tags: ['script', 'vertical video'], thumb: '/assets/capabilities/social_media_250909.png' },
  ]
  
  export const webMobile = [
    { title: 'Continuum Wealth Microsite', tags: ['UX', 'UI', 'Web'], thumb: '/assets/capabilities/web_mobile_thumb250909.png', href: 'https://example.com' },
    { title: 'Plant Wall Kiosk App', tags: ['mobile', 'prototype'], thumb: '/assets/capabilities/web_mobile_thumb250909.png' },
  ]
  
export const experiential = [
    { title: 'Pop-up Install: “Greenroom”', tags: ['wayfinding', 'brand'], thumb: '/assets/capabilities/experiential_design_thumb250909.png' },
    { title: 'In-Stadium Motion Pack', tags: ['motion', 'LED mapping'], thumb: '/assets/capabilities/experiential_design_thumb250909.png' },
  ]
...
export const capabilities = [
  ...
  },
  {
    ...
    category: 'Retail • Spatial Systems',
